...
window.geometry('1470x780')  # original
# window.geometry('1490x800') #wider
window.iconbitmap('images/img_icon.ico')
window.attributes("-alpha", 0.9)

# insert bg wallpaper--------------------

fp1 = open("images/wc22wall_dark.jpg", "rb")
fp2 = open("images/wc22_wall_other.jpg", "rb") # stadium background
...
image_wall.place(x=-123, y=-5)  # original
# image_wall.place(x=-190, y=-5) # wider
...
def create_lab_group():
    def inner(ro, name, col):
        lab_gr = customtkinter.CTkLabel(window, text=name, width=80, height=23, bg=bg_overall_GUI,
                                        corner_radius=cor_radius_std,
...
def create_place():
    def inner12(txt, ro, col):
        no1 = customtkinter.CTkLabel(window, text=txt, text_font=labfont, bg_color='black', width=15,
...
def create_teams():
    def inner(name, ro, col):
        lab_team = customtkinter.CTkLabel(window, text=name, width=80, height=23, bg=bg_overall_GUI,
                                          corner_radius=cor_radius_std,
...
def create_gr_matches():
    def inner(txt, ro, col):
        gr_label = customtkinter.CTkLabel(window, text=txt, width=30, height=23, bg=bg_overall_GUI,
                                          corner_radius=cor_radius_std,
...
def view_grA():
    ...
    for row in wc22_bend.show_teams_a():
        team = customtkinter.CTkLabel(window, text=row[1], width=137, anchor=W, height=23, bg=bg_overall_GUI,
                                      corner_radius=cor_radius_std,
...
def confirm_update():
    ...
    window_confirm_update.iconbitmap('images/img_icon.ico')
...
def confirm_reset():
    ...
    window_confirm_reset.iconbitmap('images/img_icon.ico')
...
def all_updated():
    ...
    window_updated.iconbitmap('images/img_icon.ico')
...
b_show_data.grid(row=22, column=46, padx=40, sticky=N)


def func_final_stages():
    window_ko = tkinter.Toplevel()
    window_ko.title('WORLD CUP 2022 - FINAL STAGES')
    window_ko.geometry('1700x740')
    window_ko.iconbitmap('images/img_icon.ico')
    # window_ko.attributes("-alpha", 0.9)
    # window_ko.configure(bg='black')

    fp1_final = open("images/wc22wall_dark_final.jpg", "rb") # or choose fp2 (for stadium bg)
    fp = fp1_final
    ...
    image_wall_final.place(x=-20, y=-500)
    ...
    def matches_finals():
        def inner_matches(date, info, date_ro, date_col, country1, country2):
            match_date = customtkinter.CTkLabel(window_ko, text=date, border=1, width=2, height=1, borderwidth=1,
                                                corner_radius=cor_radius_std, text_font='Verdana 9 italic',
                                                bg_color=bg_col_std, fg_color=(fg_col_std))
            match_date.grid(row=date_ro, column=date_col, pady=2, padx=20)
        ...
        # Finals
        blank_lab_final = Label(window_ko, bg='black', width=5)
        blank_lab_final.grid(row=7, column=19)
        ...
        st_lab_final = customtkinter.CTkLabel(window_ko, text='GRAND FINAL', width=80, height=23, bg='#2C3E50',
                                              corner_radius=cor_radius_std, text_font='Verdana 13 bold',
                                              fg_color=('#E74C3C'),
                                              bg_color='black')
        ...
        sec_team = customtkinter.CTkLabel(window_ko, text='...', border=1, width=2, height=1,
                                          borderwidth=1,
                                          corner_radius=cor_radius_std, anchor=CENTER, text_font='Verdana 11 bold',
        ...
        winner_team = customtkinter.CTkLabel(window_ko, text='...', border=1, width=2,
                                             height=1,
                                             borderwidth=1,
                                             corner_radius=cor_radius_std, anchor=CENTER, text_font='Verdana 14 bold',
                                             bg_color=bg_col_std, fg_color=('#FFD700'))  # gold
        winner_team.grid(row=10, column=27, padx=5, pady=2, sticky=N)

        img_trophy = Image.open('images/trophy_small.JPG')
        trophy = ImageTk.PhotoImage(img_trophy)
        win_tr = tkinter.Label(window_ko, image=trophy, relief='solid', highlightcolor='black')
        win_tr.image = trophy
        win_tr.grid(row=1, column=27, rowspan=9, sticky=S)
    ...
    def view_winners():
        ...
        if wc22_bend.show_winners()[0] != None:
            winner_team = customtkinter.CTkLabel(window_ko, text=wc22_bend.show_winners()[0], border=1, width=2,
                                                 height=1,
                                                 borderwidth=1,
                                                 corner_radius=cor_radius_std, anchor=CENTER,
                                                 text_font='Verdana 14 bold',
                                                 bg_color=bg_col_std, fg_color=('#FFD700'))  # gold
            winner_team.grid(row=10, column=27, padx=0, pady=2, sticky=N)
    ...
    def confirm_update_r16():
        ...
        window_confirm_r16.iconbitmap('images/img_icon.ico')
    ...
    def confirm_update_qf():
        ...
        window_confirm_qf.iconbitmap('images/img_icon.ico')
    ...
    def confirm_update_sf():
        ...
        window_confirm_sf.iconbitmap('images/img_icon.ico')
    ...
    def confirm_update_f():
        ...
        window_confirm_f.iconbitmap('images/img_icon.ico')
    ...
    def info_49():
        ...
        window_info.iconbitmap('images/img_icon.ico')
